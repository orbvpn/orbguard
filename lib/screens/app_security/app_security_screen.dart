...
class _AppSecurityScreenState extends State<AppSecurityScreen>
    ...
    return GlassScaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Consumer<AppSecurityProvider>(
              builder: (context, provider, child) {
                return TabBarView(
                  controller: _tabController,
                  children: [
                    _buildAppsTab(provider),
                    _buildRisksTab(provider),
  ...
  Widget _buildAppsTab(AppSecurityProvider provider) {
    return Column(
      children: [
  ...
  Widget _buildRisksTab(AppSecurityProvider provider) {
  ...
  Widget _buildStatsTab(AppSecurityProvider provider) {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
        children: [
